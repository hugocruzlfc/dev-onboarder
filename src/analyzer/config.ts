...
const CONFIG_MAP: Record<string, { tool: string; description: string }> = {
  "tsconfig.json": {
    tool: "TypeScript",
    description:
      "Configuración del compilador TypeScript (strict mode, paths, target, etc.)",
  },
  "tsconfig.build.json": {
    tool: "TypeScript",
  ...
  "next.config.js": {
    tool: "Next.js",
    description:
      "Configuración del framework Next.js (redirects, rewrites, plugins)",
  },
  "next.config.mjs": {
    tool: "Next.js",
  ...
  "docker-compose.yml": {
    tool: "Docker",
    description:
      "Configuración de Docker Compose para servicios (DB, cache, etc.)",
  },
  "docker-compose.yaml": {
    tool: "Docker",
...
export function detectConfigs(projectPath: string): ConfigInfo[] {
